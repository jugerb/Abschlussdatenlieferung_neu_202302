...
# 2019
```{r data_load_2019, warning=FALSE}
...
#Pflegegrad bis
vzpg04$V_PG_BIS[vzpg04$V_PG_BIS>"2019-12-31"] <- as.Date("2019-12-31")
vzpg04$V_PG_VON[vzpg04$V_PG_VON<"2019-01-01"] <- as.Date("2019-01-01")
...
```
IK Leistungserbringer: 29 % missing
IK Rechnungsersteller: 32 % missing
...
Gesamtkosten: 2 negative Werte, ansonsten plausible Verteilung
...
# 2021
```{r data_load_2021, warning=FALSE}
...
#Pflegegrad bis
vzpg04$V_PG_BIS[vzpg04$V_PG_BIS>"2021-12-31"] <- as.Date("2021-12-31")
vzpg04$V_PG_VON[vzpg04$V_PG_VON<"2021-01-01"] <- as.Date("2021-01-01")
